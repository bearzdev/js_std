...
import type { FormatInputPathObject, ParsedPath } from "./mod.js";
...
dntShim.Deno.test("parseTrailingWin32", function () {
...
dntShim.Deno.test("parseTrailing", function () {
