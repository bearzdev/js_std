...
import { posix, win32 } from './mod.js';
import { assertEquals, assertThrows } from '../deps.js';
dntShim.Deno.test('[path] toFileUrl', function () {
    ...
    assertThrows(() => posix.toFileUrl('foo').href, TypeError, 'Must be an absolute path.');
    assertThrows(() => posix.toFileUrl('C:/'), TypeError, 'Must be an absolute path.');
    /*
  assertEquals(
...
dntShim.Deno.test('[path] toFileUrl (win32)', function () {
    ...
    assertEquals(win32.toFileUrl('/home\\foo').href, 'file:///home/foo');
    assertThrows(() => win32.toFileUrl('foo').href, TypeError, 'Must be an absolute path.');
    assertEquals(win32.toFileUrl('C:/').href, 'file:///C:/');
    assertEquals(win32.toFileUrl('//localhost/home/foo').href, 'file:///home/foo');
    assertEquals(win32.toFileUrl('//127.0.0.1/home/foo').href, 'file://127.0.0.1/home/foo');
    assertEquals(win32.toFileUrl('//localhost/').href, 'file:///');
    assertEquals(win32.toFileUrl('//127.0.0.1/').href, 'file://127.0.0.1/');
    assertThrows(() => win32.toFileUrl('//:/home/foo').href, TypeError, 'Invalid hostname.');
});
//# sourceMappingURL=to_file_url_test.js.map