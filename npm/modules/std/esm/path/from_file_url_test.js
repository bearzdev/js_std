...
dntShim.Deno.test("[path] fromFileUrl", function () {
    ...
    assertThrows(() => posix.fromFileUrl("http://localhost/foo"), TypeError, "Must be a file URL.");
    assertThrows(() => posix.fromFileUrl("abcd://localhost/foo"), TypeError, "Must be a file URL.");
});
dntShim.Deno.test("[path] fromFileUrl (win32)", function () {
    ...
    assertThrows(() => win32.fromFileUrl("http://localhost/foo"), TypeError, "Must be a file URL.");
    assertThrows(() => win32.fromFileUrl("abcd://localhost/foo"), TypeError, "Must be a file URL.");
});
//# sourceMappingURL=from_file_url_test.js.map