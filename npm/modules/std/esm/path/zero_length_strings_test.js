...
const pwd = cwd();
dntShim.Deno.test('joinZeroLength', function () {
...
dntShim.Deno.test('normalizeZeroLength', function () {
...
dntShim.Deno.test('isAbsoluteZeroLength', function () {
...
dntShim.Deno.test('resolveZeroLength', function () {
    // resolve, internally ignores all the zero-length strings and returns the
    // current working directory
    assertEquals(path.resolve(''), pwd);
    assertEquals(path.resolve('', ''), pwd);
});
dntShim.Deno.test('relativeZeroLength', function () {
