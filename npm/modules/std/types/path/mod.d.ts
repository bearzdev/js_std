...
export declare function tmpDir(): any;
export declare function filenameWithoutExtension(path: string): string;
export declare const filename: typeof _posix.basename | typeof _win32.basename;
