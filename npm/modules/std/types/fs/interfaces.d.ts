...
export interface IFileSystem {
    createDirectory(path: string | URL, options?: ICreateDirectoryOptions): void;
    createDirectoryAsync(path: string | URL, options?: ICreateDirectoryOptions): Promise<void>;
    copyDirectory(src: string | URL, dest: string | URL, options?: ICopyOptions): void;
    copyDirectoryAsync(src: string | URL, dest: string | URL, options?: ICopyOptions): Promise<void>;
    ...
    readDirectory(path: string | URL): Array<IDirectoryInfo>;
    readDirectoryAsync(path: string | URL): Promise<Array<IDirectoryInfo>>;
    ...
    writeFile(path: string | URL, data: Uint8Array, options?: IWriteOptions): void;
    writeFileAsync(path: string | URL, data: Uint8Array, options?: IWriteOptions): Promise<void>;
    writeTextFile(path: string | URL, data: string, options?: IWriteOptions): void;
    writeTextFileAsync(path: string | URL, data: string, options?: IWriteOptions): Promise<void>;
    writeJsonFile(path: string | URL, data: any, options?: IWriteJsonOptions): void;
    writeJsonFileAsync(path: string | URL, data: any, options?: IWriteJsonOptions): Promise<void>;
}
