...
import { CommandBuilder, fromArgs, IProcessInvocationOptions, IProcessResult, run } from "@bearz/std/process/mod.js";

export function exec(exe: string, args: string | string[] | CommandBuilder, options?: IProcessInvocationOptions) : IProcessResult
...
export async function execAsync(
    ...
    options?: IProcessInvocationOptions) : Promise<IProcessResult>
