import { isWindows } from '@bearz/std/runtime/mod.js';
import { run } from '@bearz/std/process/mod.js';
let isUserAdminProcess = undefined;
let isRootAdminProcess = undefined;
