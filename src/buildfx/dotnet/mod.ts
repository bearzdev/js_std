import { VisualStudioEditions, VisualStudioVersion } from './enums.ts';
...
export { createMachineKey } from './machine-key.ts';
...
export function findMsBuild(
    ...
    const query = is64Bit ? 'MSBuild\\**\\Bin\\amd64\\MSBuild.exe' : 'MSBuild\\**\\Bin\\MSBuild.exe';
